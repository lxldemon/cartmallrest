package com.liuxl.cartmall.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.liuxl.cartmall.admin.common.persistence.model");
        packageConfig.setMapper("com.liuxl.cartmall.admin.common.persistence.dao");
        packageConfig.setXml("com.liuxl.cartmall.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.liuxl.cartmall.admin");
        contextConfig.setCoreBasePackage("com.liuxl.cartmall.core");
