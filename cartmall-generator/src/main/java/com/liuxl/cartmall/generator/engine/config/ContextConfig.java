package com.liuxl.cartmall.generator.engine.config;
...
public class ContextConfig {
    ...
    private String proPackage = "com.liuxl.cartmall.admin";
    private String coreBasePackage = "com.liuxl.cartmall.core";
    private String modelPackageName = "com.liuxl.cartmall.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.liuxl.cartmall.modular.system.dao";    //model的dao
